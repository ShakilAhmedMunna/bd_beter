...
schedule_prf.`schedule_hon` from schedule_prf INNER JOIN  prf_artist ON schedule_prf.`schedule_prf_id` = prf_artist.`prf_code` and prf_code='$id' and schedule_agree_cancel=1;");
$re_time=mysqli_fetch_array($res);
$res2=mysqli_query($conn,"select schedule_prf.`schedule_prf_recording_time`,schedule_prf
.`schedule_prf_telecst_time`,schedule_prf.`schedule_prf_prg_duration`,
schedule_prf.`schedule_hon` from schedule_prf INNER JOIN  prf_artist ON schedule_prf.`schedule_prf_id` = prf_artist.`prf_code` and prf_code='$id' and schedule_agree_cancel=1;");
...
<div class="well">
    ...
    <div class="row"><div class="col-sm-4">&nbsp;</div>
        ...
        <div class="col-sm-4" style="text-align:center;"><h4>বাংলাদেশ বেতার,সিলেট</h4><br><h4>Agreement</h4> <br><p>*Invited from Bangladesh Betar's programme are show's here which if you are press <strong>Agree</strong></p></div><div class="col-sm-4">&nbsp;</div></div>
         
<h5><a href="art_dash.php">Dashboard</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i> <a href="inbox.php">Agreement</a> </h5>
